...
#
#
# def create_file(content="", titled="Untitled"):
#     text_area = tk.Text(notebook)
#     text_area.insert("end", content)
#
#     text_area.pack(fill="both", expand=True)
#     notebook.add(text_area, text=titled)
...
# def current_tab_unsaved():
#     text_widget = get_text_widget()
#     content = text_widget("1.0", "end-1c")
#     return hash(content) != text_contents[str(text_widget)]
#
#
# def confirm_close():
...
# file_menu.add_command(label="Open", command=open_file, accelerator="Ctrl+O")
# file_menu.add_command(label="Save", command=save_file, accelerator="Ctrl+S")
# file_menu.add_command(label="Close Tab", command=confirm_quit, accelerator="Ctrl+Q")
# file_menu.add_command(label="Exit", command=confirm_quit)
#
# notebook = ttk.Notebook(main)
# notebook.pack(fill="both", expand=True)
